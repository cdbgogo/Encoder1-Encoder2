...
def xavier_initializer(factor=1, uniform=False, seed=None, dtype=dtypes.float32):
    ...
    return variance_scaling_initializer(factor=factor, mode='FAN_AVG', scale=factor,
                                       uniform=uniform, other=True, seed=seed, dtype=dtype)
